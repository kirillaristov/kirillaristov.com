...
1. Создать рабочий каталог и разместить в нем стандартный набор файлов
2. Перейти в созданный рабочий каталог `cd c:\www\kir.com`
3. Инициализировать git `git init`
4. `git add .`
5. `git commit`
6. Запустить hugo `hugo server`. Устранить ошибки при их наличии
